    ...
    <div class="detail-container">
        <el-container>
            ...
            <el-main style="margin-top: 200px;">
                ...
                <el-pagination background v-model:currentPage="currentPage" v-model:page-size="pageSize" :small="small"
...
import { infoPosts, addComment, appendComment } from '@/api/post'
...
const CurPage = (): Comment[] => {
    if (currentPage.value <= comments.value.length) {
        return comments.value.slice(0, currentPage.value + 10)
    }
    return []
}
